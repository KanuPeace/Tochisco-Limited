                    ...
                    <div class="col-lg-4">
                        <div class="profile-agent-widget">
                            <ul>
                                ...
                                <li>Email <span>princekanu8@gmail.com</span></li>
                                <li>Phone <span>09056112346</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="profile-agent-newslatter">
                            <h5>Send Message to Prince kanu</h5>
                            <form action="#">
    ...
    <div class="container">
        ...
        <div class="copyright-text">
            <p>
                ...
                by <a href="https://bootthemes.com/" target="_blank">BootThemes</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
        </div>
    </div>
