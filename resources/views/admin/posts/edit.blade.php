        ...
        <div class="statbox widget box box-shadow mt-5">
            ...
            <div class="widget-content widget-content-area">
                <form enctype="multipart/form-data" class="form-row"
                    action="{{ route('admin.blog.posts.update', $post->id) }}" method="POST"> @csrf @method("PUT")
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input class="form-control" type="text" required name="title" value="{{ $post->title }}"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select name="is_sponsored" class="form-control" id="" required>
                            ...
                            @foreach ($boolOptions as $key => $value)
                                <option value="{{ $key }}" {{ $key == $post->is_sponsored ? 'selected' : '' }}>
                                    {{ $value }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select name="is_top_story" class="form-control" id="" required>
                            <option value="" disabled selected>Select Option</option>
                            @foreach ($boolOptions as $key => $value)
                                <option value="{{ $key }}" {{ $key == $post->is_top_story ? 'selected' : '' }}>
                                    {{ $value }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select name="is_featured" class="form-control" id="" required>
                            <option value="" disabled selected>Select Option</option>
                            @foreach ($boolOptions as $key => $value)
                                <option value="{{ $key }}" {{ $key == $post->is_featured ? 'selected' : '' }}>
                                    {{ $value }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select name="is_published" class="form-control" id="" required>
                            <option value="" disabled selected>Select Option</option>
                            @foreach ($boolOptions as $key => $value)
                                <option value="{{ $key }}" {{ $key == $post->is_published ? 'selected' : '' }}>
                                    {{ $value }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select name="can_comment" class="form-control" id="" required>
                            <option value="" disabled selected>Select Option</option>
                            @foreach ($boolOptions as $key => $value)
                                <option value="{{ $key }}" {{ $key == $post->can_comment ? 'selected' : '' }}>
                                    {{ $value }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <input class="form-control" type="text" name="meta_title" required value="{{ $post->meta_title }}"
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input class="form-control" type="text" name="meta_description" required
                            value="{{ $post->meta_description }}" placeholder="Summarize the blog post">
                    </div>
